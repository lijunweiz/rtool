package com.lijw.decision.core.result;
...
public class Result<T> {
    ...
    public static <T> Result<T> fail() {
        return Result.fail(DefaultValue.INT_400, DefaultValue.MSG_FAIL, null);
    }
    ...
    public static <T> Result<T> fail(T data) {
        return Result.fail(DefaultValue.INT_400, DefaultValue.MSG_FAIL, data);
    }
    ...
    public static <T> Result<T> fail(int code, String msg, T data) {
        return Result.both(code, DefaultValue.FALSE, msg, data);
    }
